...
exports.handleControllerMenus = (request, reply) => {
    model_get.handleModelMenus(request, (err, result) => {
            if(err === true){
...
// exports.handleControllerWordpay = (request, reply) => {
//     model_get.handleModelWordpayUsers(request, (err, result) => {
//             if(err === true){
//                 console.log("Error From Controller")
//             } 
//             reply({
