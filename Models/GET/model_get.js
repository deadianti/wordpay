...
exports.handleModelMenus = (request, callback) => {
    const queryStatment = 'SELECT id_menu, nama, harga FROM menu WHERE 1'
...
// exports.handleModelWordpayUsers = (request, callback) => {
//     const queryStatment = 'SELECT id_user, username, password, created_at FROM users WHERE 1'
//     connection_mysql.connection.query(queryStatment,  (errorDB, resultsDB, fieldsDB) => {
//         if(errorDB){ 
//                 throw errorDB
//                 console.log('ADA ERROR BRO')
